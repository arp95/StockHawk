    ...
    @Override public int onRunTask(TaskParams params) {
        ...
        if (params.getTag().equals("init") || params.getTag().equals("periodic")) {
            ...
            initQueryCursor = mContext.getContentResolver()
                    .query(QuoteProvider.Quotes.CONTENT_URI, new String[] { "Distinct " + QuoteColumns.SYMBOL }, null, null, null);
        ...
        if (urlStringBuilder != null) {
            ...
            //Toast.makeText(mContext , urlString , Toast.LENGTH_LONG).show();
            Log.e("###", "onRunTask: " + urlString);
            try {
                getResponse = fetchData(urlString);
                Log.e("***********", "onRunTask: " + getResponse);
                if(getResponse!=null) {
                    ...
                    try {
                        ...
                        mContext.getContentResolver()
                                .applyBatch(QuoteProvider.AUTHORITY, Utils.quoteJsonToContentVals(mContext , getResponse));
